...
public class CreateEventRequestValidatorTests
{
    ...
    {
        var request = new CreateEventRequest(Name: null, Description: "Test Description",
            Date: DateTime.UtcNow.AddDays(1), StartTime: DateTime.UtcNow.AddHours(1),
            EndTime: DateTime.UtcNow.AddHours(2), Price: 10);
    ...
    {
        var request = new CreateEventRequest(Name: "a", Description: "Test Description",
            Date: DateTime.UtcNow.AddDays(1), StartTime: DateTime.UtcNow.AddHours(1),
            EndTime: DateTime.UtcNow.AddHours(2), Price: 10);
    ...
    {
        var request = new CreateEventRequest(Name: new string('a', 101), Description: "Test Description",
            Date: DateTime.UtcNow.AddDays(1), StartTime: DateTime.UtcNow.AddHours(1),
            EndTime: DateTime.UtcNow.AddHours(2), Price: 10);
    ...
    {
        var request = new CreateEventRequest(Name: "Test Name", Description: null, Date: DateTime.UtcNow.AddDays(1),
            StartTime: DateTime.UtcNow.AddHours(1), EndTime: DateTime.UtcNow.AddHours(2), Price: 10);
    ...
    {
        var request = new CreateEventRequest(Name: "Test Name", Description: "a", Date: DateTime.UtcNow.AddDays(1),
            StartTime: DateTime.UtcNow.AddHours(1), EndTime: DateTime.UtcNow.AddHours(2), Price: 10);
    ...
    {
        var request = new CreateEventRequest(Name: "Test Name", Description: new string('a', 501),
            Date: DateTime.UtcNow.AddDays(1), StartTime: DateTime.UtcNow.AddHours(1),
            EndTime: DateTime.UtcNow.AddHours(2), Price: 10);
    ...
    public void Should_Have_Error_When_EndTime_Is_In_The_Past()
    {
        var request = new CreateEventRequest(Name: "Test Name", Description: "Test Description",
            Date: DateTime.UtcNow.AddDays(1), StartTime: DateTime.UtcNow.AddHours(1),
            EndTime: DateTime.UtcNow.AddHours(-1), Price: 10);
    ...
    {
        var request = new CreateEventRequest(Name: "Test Name", Description: "Test Description",
            Date: DateTime.UtcNow.AddDays(1), StartTime: DateTime.UtcNow.AddHours(2),
            EndTime: DateTime.UtcNow.AddHours(1), Price: 10);
    ...
    public void Should_Have_Error_When_Price_Is_Negative()
    {
        var request = new CreateEventRequest(Name: "Test Name", Description: "Test Description",
            Date: DateTime.UtcNow.AddDays(1), StartTime: DateTime.UtcNow.AddHours(1),
            EndTime: DateTime.UtcNow.AddHours(2), Price: -1);
